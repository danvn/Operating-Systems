 ...
 *	Command Line Usage: "Usage: ./pa5-encfs <passphrase> <mirror_directory> <mount_point>
 *  
 *      Luke Woodruff
 */
...
#define USAGE "Usage:\n\t./fuseenc <passphrase> <mirror_directory> <mount_point>\n"
...
{
  strcpy(fpath, ENC_DATA->mirror_dir);
